...
insert into staging.genres (genre, description) values
    ...
    ('Thriller', 'Literary works that are fast-paced, suspenseful, and thrilling'),
    ...
    ('Art', 'Literary works that explore artistic movements, styles, and techniques'),
    ('Poetry', 'Literary works that use rhythmic and expressive language to evoke emotions and imagery'),
    ('Drama', 'Literary works that are intended to be performed on stage or screen'),
...
insert into staging.books (book_id, book_title, genre, publisher_id, notes) values
    ...
    ('B002', 'Not Another Great Novel', 'Non-Fiction', 'P002', 'A comprehensive guide to writing a great novel'),
    ('B003',   'Sci-Fi Adventures', 'Sci-Fi', 'P008', 'Explore the universe with these thrilling stories'),
    ...
    ('B007', 'Horror Stories', 'Horror', 'P011', 'Prepare to be scared with these chilling stories'),
    ('B008', 'Thriller Frenzy', 'Thriller', 'P009', 'Fast-paced action and suspense await you'),
    ('B009', 'Biography of a Legend', 'Biography', 'P012', 'Discover the life of a legendary figure'),
    ...
    ('B012', 'Culinary Creations', 'Cookbook', 'P014', 'Delicious recipes for every occasion'),
    ...
    ('B016', 'Poetry Collection', 'Poetry', 'P019', 'Experience the power of poetry in all its forms'),
    ('B017', 'Dramatic Plays', 'Drama', 'P020', 'Plays that will captivate and entertain audiences'),
